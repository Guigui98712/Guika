...
const etapasConfig = [
  { id: '1', nome: 'Terraplenagem', position: { x: 0, y: 0 } },
  { id: '2', nome: 'Fundação', position: { x: 200, y: 0 } },
  { id: '3', nome: 'Infraestrutura', position: { x: 400, y: 0 } },
  { id: '4', nome: 'Alvenaria', position: { x: 600, y: -50 } },
  { id: '5', nome: 'Estrutura', position: { x: 600, y: 50 } },
  { id: '6', nome: 'Instalações Elétricas', position: { x: 800, y: -100 } },
  { id: '7', nome: 'Instalações Hidráulicas', position: { x: 800, y: 0 } },
  { id: '8', nome: 'Passagens', position: { x: 800, y: 100 } },
  { id: '9', nome: 'Cobertura', position: { x: 1000, y: -100 } },
  { id: '10', nome: 'Revestimento Interno', position: { x: 1000, y: 0 } },
  { id: '11', nome: 'Revestimento Externo', position: { x: 1000, y: 100 } },
  { id: '12', nome: 'Reboco Interno', position: { x: 1200, y: -50 } },
  { id: '13', nome: 'Reboco Externo', position: { x: 1200, y: 50 } },
  { id: '14', nome: 'Pisos', position: { x: 1400, y: -100 } },
...
const FluxogramaObra: React.FC<FluxogramaObraProps> = ({ registros }) => {
  ...
  const edges: Edge[] = [
    // 1-3: Sequência inicial
    { id: 'e1-2', source: '1', target: '2' },
    { id: 'e2-3', source: '2', target: '3' },
    
    // 4: Alvenaria e Estrutura (paralelos)
    { id: 'e3-4', source: '3', target: '4' },
    { id: 'e3-5', source: '3', target: '5' },
    
    // 5: Passagens e Laje (paralelos)
    ...
    // 6: Cobertura e Instalações (paralelos)
    ...
    // 7: Reboco e Regularização (paralelos)
    ...
    // 8: Revestimento, Gesso e Marmoraria (paralelos)
    ...
    // 9-11: Sequência Pintura, Esquadrias, Limpeza Bruta
    ...
    // 12: Marcenaria e Metais (paralelos)
